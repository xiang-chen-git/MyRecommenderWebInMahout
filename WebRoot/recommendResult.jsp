...
<html>
 ...
 // 	System.out.println("recommendMovieInfo.size()"+recommendMovieInfo.size());
  ...
  <body>
    ...
    <table border="0">
    <tr><td align="left" colspan="4"><font color="blue">The movie which is watched</font></td></tr>
    <tr><td>Movie name</td><td>publish date</td><td>moive type</td><td>the user's grade</td></tr>
    <%
  		//定义一个颜色数组
    ...
    <td width="50%" align="center" valign="top">
    <table border="0">
    <tr><td align="left" colspan="4"><font color="blue">The recommend result</font></td></tr>
    <!-- <tr><td>Movie Name</td><td>Published Year</td><td>Movie Type</td><td>Score</td></tr> -->
    <tr><td>Moive name</td><td>publish date</td><td>moive type</td><td>the user's grade</td></tr>
